...
syntax 	keyword	ofSnappyHexMeshType file inside outside distance searchableSphere searchableBox triSurfaceMesh 
...
syn	keyword ofBoundaryDictConst patch wall symmetryPlane empty cyclic inlet; outlet;
highlight link  ofBoundaryDictConst Boolean

syn	keyword ofBoundaryDictConstant type nFaces startFace
